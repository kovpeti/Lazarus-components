...
begin
     ...
     // All signs but Neg,AC,DC,LedNumbers
     ...
     //if trystrtofloat(NumDisplay,Value) then
     //   FDisplay.Value:=round2(Value,Digits) else MeasuredValue:=0;
...
begin
     ...
     //FDisplay.Text:=inttostr(Command);
end;
