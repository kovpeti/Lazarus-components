...
//  protected
    ...
    procedure ClearButton(const Value:integer);             {Clear pressed button}{ TODO -cInfo : Without define Value does not work }
  public
    { Public declarations }
